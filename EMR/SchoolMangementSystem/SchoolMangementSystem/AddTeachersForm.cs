                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\dieg0\OneDrive\Escritorio\Proyecto Final\School-Management-System-using-CSharp\SchoolMangementSystem\SchoolMangementSystem\Teacher_Directory", teacher_id.Text.Trim() + ".jpg");
